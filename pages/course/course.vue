<template>
	<view class="page">
		...
		<scroll-view class="scroll-container" scroll-y="true" @scrolltolower="loadMoreData">
			<view class="content">
				<view class="live-list" v-for="(item, index) in list" :key="item.id" @click="viewLiveInfo(item.id, item.sort)">
					...
					<view class="live-list-info">
						...
						<view class="live-teacher-price">
							...
							<view class="price-wrap">
								<button open-type="share" class="share-button" @tap.stop="shareCourse(item)">
